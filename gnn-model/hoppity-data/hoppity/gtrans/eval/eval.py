...
save_dir = "/mnt/volume1/model-sliced/hoppity-data/ml_patch"
...
model.load_state_dict(torch.load(cmd_args.target_model), strict=False)
model.eval()
...
print('able to fix {} out of {} samples'.format(total_acc, total_num_samples))
